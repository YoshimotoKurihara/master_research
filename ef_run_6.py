...
from ef_model_6 import effnetv2_m
from ef_dataloader_6 import Dataloaders
from ef_trainer_6 import MyTrainer
# import hparams
# import datasets
"""
...
def main():
    ...
    BATCH_SIZE = 128 #こことsubmodel.py 85行目と113行目の最初の引数を変える #model.pyの96行目と119行目も変える必要がある。
    #BATCH_SIZE = 10
    ...
    model1 = effnetv2_m(num_classes=13*18).to(device)
