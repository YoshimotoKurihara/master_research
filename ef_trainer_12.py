...
class MyTrainer:
    ...
    def iter(self, train):
        ...
        for i, batch in enumerate(data_iter):
            ...
            class_and_pose_list = class_and_pose_list.view(-1,num_classes * num_objects)
            ...
            class_predicts=torch.argmax(class_and_pose[:,:num_classes - 6],dim=1)
            class_list = torch.argmax(class_and_pose_list[:,:num_classes - 6],dim=1)
